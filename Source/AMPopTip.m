...
- (void)commonInit {
    ...
    _paddingVertical = kDefaultPadding;
    _paddingHorizontal = kDefaultPadding;
...
- (void)setup {
    if (self.direction == AMPopTipDirectionLeft) {
        self.maxWidth = MIN(self.maxWidth, self.fromFrame.origin.x - self.paddingHorizontal * 2 - self.edgeInsets.left - self.edgeInsets.right - self.arrowSize.width);
    }
    if (self.direction == AMPopTipDirectionRight) {
        self.maxWidth = MIN(self.maxWidth, self.containerView.bounds.size.width - self.fromFrame.origin.x - self.fromFrame.size.width - self.paddingHorizontal * 2 - self.edgeInsets.left - self.edgeInsets.right - self.arrowSize.width);
    }
    ...
    _textBounds.origin = (CGPoint){self.paddingHorizontal + self.edgeInsets.left, self.paddingVertical + self.edgeInsets.top};
    ...
    if (self.direction == AMPopTipDirectionUp || self.direction == AMPopTipDirectionDown) {
        frame.size = (CGSize){self.textBounds.size.width + self.paddingHorizontal * 2.0 + self.edgeInsets.left + self.edgeInsets.right, self.textBounds.size.height + self.paddingVertical * 2.0 + self.edgeInsets.top + self.edgeInsets.bottom + self.arrowSize.height};
        ...
        frame.size = (CGSize){ self.textBounds.size.width + self.paddingHorizontal * 2.0 + self.edgeInsets.left + self.edgeInsets.right + self.arrowSize.height, self.textBounds.size.height + self.paddingVertical * 2.0 + self.edgeInsets.top + self.edgeInsets.bottom};
        ...
        frame.size = (CGSize){ self.textBounds.size.width + self.paddingHorizontal * 2.0 + self.edgeInsets.left + self.edgeInsets.right, self.textBounds.size.height + self.paddingVertical * 2.0 + self.edgeInsets.top + self.edgeInsets.bottom };
